...
class Config(object):
    ...
    OWNER_ID = int(os.environ.get("OWNER_ID",1005016475 ))
    ...
    DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "http://tgfile.stream.seshu.co/46801983723116/2020-12-09_17:22:51.jpg")
    ...
    LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@ProfessorSnapebot")
    YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@ProfessorSnapebot")
    ...
    PYTDL_COMMAND_G = os.environ.get("PYTDL_COMMAND_G", "pytdl@ProfessorSnapebot")
